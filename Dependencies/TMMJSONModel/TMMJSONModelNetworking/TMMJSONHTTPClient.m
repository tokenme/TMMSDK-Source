...
typedef void (^RequestResultBlock)(NSData *data, TMMJSONModelError *error);
...
@implementation TMMJSONHTTPClient
...
+(void)requestDataFromURL:(NSURL*)url method:(NSString*)method requestBody:(NSData*)bodyData headers:(NSDictionary*)headers handler:(RequestResultBlock)handler
{
    ...
    void (^completionHandler)(NSData *, NSURLResponse *, NSError *) = ^(NSData *data, NSURLResponse *origResponse, NSError *origError) {
        ...
        //convert an NSError to a TMMJSONModelError
        if (origError) {
            error = [TMMJSONModelError errorWithDomain:origError.domain code:origError.code userInfo:origError.userInfo];
        }
        ...
        //if not OK status set the err to a TMMJSONModelError instance
        if (!error && (response.statusCode >= 300 || response.statusCode < 200)) {
            error = [TMMJSONModelError errorBadResponse];
        }

        //if there was an error, assign the response to the TMMJSONModel instance
        if (error) {
...
+(void)JSONFromURLWithString:(NSString*)urlString method:(NSString*)method params:(NSDictionary*)params orBodyString:(NSString*)bodyString completion:(TMMJSONObjectBlock)completeBlock
{
...
+(void)JSONFromURLWithString:(NSString *)urlString method:(NSString *)method params:(NSDictionary *)params orBodyString:(NSString *)bodyString headers:(NSDictionary *)headers completion:(TMMJSONObjectBlock)completeBlock
{
    [self JSONFromURLWithString:urlString
                         method:method
                         params:params
...
+(void)JSONFromURLWithString:(NSString*)urlString method:(NSString*)method params:(NSDictionary *)params orBodyData:(NSData*)bodyData headers:(NSDictionary*)headers completion:(TMMJSONObjectBlock)completeBlock
{
    RequestResultBlock handler = ^(NSData *responseData, TMMJSONModelError *error) {
        id jsonObject = nil;
...
+(void)getJSONFromURLWithString:(NSString*)urlString completion:(TMMJSONObjectBlock)completeBlock
{
    [self JSONFromURLWithString:urlString method:kHTTPMethodGET
                         params:nil
                   orBodyString:nil completion:^(id json, TMMJSONModelError* e) {
                       if (completeBlock) completeBlock(json, e);
                   }];
}

+(void)getJSONFromURLWithString:(NSString*)urlString params:(NSDictionary*)params completion:(TMMJSONObjectBlock)completeBlock
{
    [self JSONFromURLWithString:urlString method:kHTTPMethodGET
                         params:params
                   orBodyString:nil completion:^(id json, TMMJSONModelError* e) {
...
+(void)postJSONFromURLWithString:(NSString*)urlString params:(NSDictionary*)params completion:(TMMJSONObjectBlock)completeBlock
{
...
+(void)postJSONFromURLWithString:(NSString*)urlString bodyString:(NSString*)bodyString completion:(TMMJSONObjectBlock)completeBlock
{
    [self JSONFromURLWithString:urlString method:kHTTPMethodPOST
                         params:nil
                   orBodyString:bodyString completion:^(id json, TMMJSONModelError* e) {
                       if (completeBlock) completeBlock(json, e);
                   }];
}

+(void)postJSONFromURLWithString:(NSString*)urlString bodyData:(NSData*)bodyData completion:(TMMJSONObjectBlock)completeBlock
{
    [self JSONFromURLWithString:urlString method:kHTTPMethodPOST
                         params:nil
                   orBodyString:[[NSString alloc] initWithData:bodyData encoding:defaultTextEncoding]
                                 completion:^(id json, TMMJSONModelError* e) {
                       if (completeBlock) completeBlock(json, e);
                   }];
}
