...
#import "TMMJSONValueTransformer.h"
#import "TMMJSONKeyMapper.h"
 ...
 */
@interface NSObject (TMMJSONModelPropertyCompatibility) <Optional, Ignore>
@end

/////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - TMMJSONModel protocol
/**
 * A protocol describing an abstract TMMJSONModel class
 * TMMJSONModel conforms to this protocol, so it can use itself abstractly
 */
@protocol AbstractTMMJSONModelProtocol <NSCopying, NSCoding>

@required
/**
 * All TMMJSONModel classes should implement initWithDictionary:
 *
 * For most classes the default initWithDictionary: inherited from TMMJSONModel itself
...
/**
 * All TMMJSONModel classes should implement initWithData:error:
 *
 * For most classes the default initWithData: inherited from TMMJSONModel itself
 * should suffice, but developers have the option to also overwrite it if needed.
 *
...
/**
 * All TMMJSONModel classes should be able to export themselves as a dictionary of
 * JSON compliant objects.
 *
 * For most classes the inherited from TMMJSONModel default toDictionary implementation
 * should suffice.
 *
 * @return NSDictionary dictionary of JSON compliant objects
 * @exception TMMJSONModelTypeNotAllowedException thrown when one of your model's custom class properties
...
/////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - TMMJSONModel interface
/**
 * The TMMJSONModel is an abstract model class, you should not instantiate it directly,
 ...
 */
@interface TMMJSONModel : NSObject <AbstractTMMJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(TMMJSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 * @exception TMMJSONModelTypeNotAllowedException thrown when unsupported type is found in the incoming JSON,
 ...
 */
- (instancetype)initWithString:(NSString *)string error:(TMMJSONModelError **)err;
 ...
 * or a property type in your model is not supported by JSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(TMMJSONModelError **)err;
 ...
 * @exception TMMJSONModelTypeNotAllowedException thrown when unsupported type is found in the incoming JSON,
 * or a property type in your model is not supported by JSONValueTransformer and its categories
 * @exception TMMJSONModelInvalidDataException thrown when the input data does not include all required keys
 ...
 * @param array list of TMMJSONModel objects
 ...
 * This method gets called at the very end of the TMMJSONModel initializer, thus the model is in the state that you would
 ...
 * [TMMJSONModelError errorModelIsInvalid] to set the NSError param if the data fails your custom validation
 */
