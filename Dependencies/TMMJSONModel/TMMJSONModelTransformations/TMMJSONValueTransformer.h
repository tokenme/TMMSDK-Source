...
#pragma mark - TMMJSONValueTransformer interface
/**
 ...
 * Just few examples of what can you add to TMMJSONValueTransformer: hex colors in JSON to UIColor,
 * hex numbers in JSON to NSNumber model properties, base64 encoded strings in JSON to UIImage properties, and more.
 *
 * The class is invoked by TMMJSONModel while transforming incoming
 * JSON types into your target class property classes, and vice versa.
 * One static copy is create and store in the TMMJSONModel class scope.
 */
@interface TMMJSONValueTransformer : NSObject
