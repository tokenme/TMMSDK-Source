...
@implementation TMMJSONKeyMapper

- (instancetype)initWithJSONToModelBlock:(TMMJSONModelKeyMapBlock)toModel modelToJSONBlock:(TMMJSONModelKeyMapBlock)toJSON
{
...
{
    NSDictionary *toJSON  = [TMMJSONKeyMapper swapKeysAndValuesInDictionary:map];
...
- (TMMJSONModelKeyMapBlock)JSONToModelKeyBlock
{
    return nil;
}
...
+ (instancetype)mapper:(TMMJSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions
{
    NSDictionary *toJSON = [TMMJSONKeyMapper swapKeysAndValuesInDictionary:exceptions];
