...

{
    ...
    NSData *result = [TMMAES256 AES256ParmEncryptWithKey:key Encrypttext:data];
...

{
    ...
    NSData* result = [TMMAES256  AES256ParmDecryptWithKey:key Decrypttext:data];
